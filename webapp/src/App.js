...
import abi from "./contracts/GorotzCoin.json";
...
function App() {
  ...
  const contractAddress = "0x86cc78EfA4C11325dB5D89483b86250d08c3AaDA";
  ...
  return (
    <main className="main-container">
      <h2 className="headline">
        <span className="headline-gradient">GorotzCoin Project</span>
        <img
